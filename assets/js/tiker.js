		...
		return this.each(function() { 
			...
			function initialisePage() {
				...
				if (opts.controls) {
					...
					$(document).on("click",settings.dom.playPauseID, function()   {
						// console.log("Play Pause Ahmed");
					...
					$(document).on("click",settings.dom.prevID, function()   {
						// console.log("Previous Ahmed");
						settings.paused = true;
						$(settings.dom.playPauseID).addClass('paused');
						manualChangeContent('prev');
					});
					$(document).on("click",settings.dom.nextID, function()   {
						// console.log("Next Ahmed");
						settings.paused = true;
						$(settings.dom.playPauseID).addClass('paused');
						manualChangeContent('next');
					});
					$(settings.dom.controlsID).on('mouseover', function (e) {
					...
					$(settings.dom.controlsID).on('mouseout', function (e) {
						var button = e.target.id;
						if ( $('#' + button).hasClass('controls')) {
							$('#' + button).removeClass('over');
						}
					});
					$(settings.dom.controlsID).on('mouseup', function (e) {
						var button = e.target.id;
						if ( $('#' + button).hasClass('controls')) {
							$('#' + button).removeClass('down');
						}
					});
					$(settings.dom.controlsID).on('mousedown', function (e) {
						var button = e.target.id;
						if ( $('#' + button).hasClass('controls')) {
